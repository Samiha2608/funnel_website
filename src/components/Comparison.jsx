...
const Comparison = () => {
  return (
    <section className="bg-bgColor py-16 relative">
      {/* Heading */}
  ...
  Comparison
      ...
      {/* Comparison Section */}
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 px-4 md:px-0 relative">
        
        {/* Other Companies Label */}
        <div className="absolute -top-8 left-0 w-full md:w-1/2 flex justify-center">
        ...
        <div className="relative p-4 mt-6 bg-gradient-to-tl from-gray-700 to-gray-800 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 mx-auto max-w-sm">
        ...
        {/* Our Agency Label */}
        <div className="absolute -top-8 right-0 w-full md:w-1/2 flex justify-center">
          <h3 className="text-2xl font-title text-primaryAccent">
            Our Agency
          </h3>
        </div>

        {/* Our Agency Card */}
        <div className="relative p-4 mt-6 bg-gradient-to-br from-secondaryAccent/10 via-secondaryAccent/20  to-secondaryAccent/80 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 mx-auto max-w-sm">
